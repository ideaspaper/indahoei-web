...
import avatarImage from '@/assets/indahoei.jpeg';
      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            <MobileNavItem href={APP_PATH_MAP.about.getHref()}>
              About
            </MobileNavItem>
            <MobileNavItem href={APP_PATH_MAP.projects.getHref()}>
              Projects
            </MobileNavItem>
            <MobileNavItem href={APP_PATH_MAP.speaking.getHref()}>
              Speaking
            </MobileNavItem>
            <MobileNavItem href={APP_PATH_MAP.uses.getHref()}>
              Uses
            </MobileNavItem>
          </ul>
        </nav>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem to={APP_PATH_MAP.about.getHref()}>About</NavItem>
        <NavItem to={APP_PATH_MAP.projects.getHref()}>Projects</NavItem>
        <NavItem to={APP_PATH_MAP.speaking.getHref()}>Speaking</NavItem>
        <NavItem to={APP_PATH_MAP.uses.getHref()}>Uses</NavItem>
      </ul>
    </nav>
  );
};
          ...
          >
            <div className="relative flex gap-4">
              <div className="flex flex-1">
                {!isHomePage && (
                  <AvatarContainer>
                    <Avatar to={APP_PATH_MAP.root.getHref()} />
                  </AvatarContainer>
                )}
              </div>
